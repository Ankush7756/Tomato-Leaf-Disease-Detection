...
filepath = 'C:/Users/choud/Desktop/Plant-Leaf-Disease-Prediction/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/choud/Desktop/Plant-Leaf-Disease-Prediction\Dataset/test/Tomato___Early_blight (1).JPG')
